...
%Load datacsv
load(['D:\Users\JEisenbarth\Desktop\PowerWorld Files\CENTRG1 Real PMU Data\CENTRG1_CSV_Event_20400to20420.mat']);
...
%         
        ...
        [data_orig(k,x)] = PowerWorld_WriteDYD_Run_RealPMU(filenamedyd,genrou_original,exac8b_original,pss2a_original,SimAuto,filename_RunAux,filename_PlayInCase);
        ...
        [final_theta(k,x),resnorm(k,x),residual,exitflag,output(k,x),lambda,Jacobian] = lsqnonlin(residual,theta,lb(k),[],opts);
